...
//   await multiThread.default();
//   await multiThread.initThreadPool(navigator.hardwareConcurrency);
//   const ret = multiThread.prove_pkcs1v15_1024_128_circuit(params, pk, public_key, msg, signature);
//   return ret;
// }

// async function verify_1024_128(
//   proof: any
// ): Promise<boolean> {
//   const params = await fetch_params();
//   const vk = await fetch_vk();
...
//   await multiThread.default();
//   await multiThread.initThreadPool(navigator.hardwareConcurrency);
//   const ret = multiThread.verify_pkcs1v15_1024_128_circuit(params, vk, proof);
//   return ret;
// }
